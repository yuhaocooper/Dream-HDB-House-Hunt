...
- Window width is a problem - makes place feel cramped
- Not open enough. Want light and windows like modern condos with wide full-length glass windows.

**Positives:**
- Living room feels wide enough
- Low density area, no feeling of crowd

**Key Insight:** This viewing confirmed the new standard 4A layout is not acceptable.
...
- Views towards other blocks - disappointing
- Master bedroom small (previous owners knocked down wall to enlarge)
- Service yard has the view, but pointless since you don't spend time there

**Positives:**
- Square layout of living room makes it feel bigger
- Area is still good

**Conclusion:** Kim Tian area is acceptable, but need units facing **east side**.
...
- **Lighting:** Way too dark. Windows aren't great. Dark corners in entryway and dining area.
- **Tiles:** Ugly (applies to all Jan 31 viewings)
- **Layout:** Feels cramped
- **Sun:** West-facing in some rooms
- **Level:** Too low for breeze

**Positives:**
- Next to MRT (convenient)
- Decent toilet size
- Living room width adequate

**Conclusion:** Entire block is a no-go. Remove from all future lists.
...
- Super windy (almost blowing you over)
- Large living/dining with potential for unique design
- Combined master room is good size
- Walking distance to Outram MRT acceptable
- Low density area, no feeling of crowd

**Issues:**
- No dedicated service yard - drying clothes problematic
- AYE highway noise in bedroom
- Toilet hilariously small
- Interior old - needs wholesale renovation
...
|----------|-------------|--------|
| Wide windows throughout | **NON-NEGOTIABLE** |
| Level 15+ | **NON-NEGOTIABLE** |
| Openness & windiness | Required |
| Unobstructed views | Required |
| No west-sun | Required |
| Quiet (no constant drone) | Required |

**Noise Benchmark:** Current room has some vehicle sounds that go unnoticed most of the time. This level of background noise is acceptable.

### Babe's Priorities
1. **Convenience** of the area
2. **Brightness** of the space
...
- Feels dead and uninspiring
- Not open - feels cramped and trapped
...
|-------------|--------|-------|
| Wide windows throughout | **NON-NEGOTIABLE** | Want slider/foldable windows, no grills. Full-length glass like modern condos. |
| Above level 15 | **NON-NEGOTIABLE** | For windiness |
| Bright interior | Required | Can't feel dark like Redhill |
| Quiet location | Required | Current room noise level is the benchmark |
| Remaining lease 70-75 years | Required | Comparable lease decay to newer flats |
| Decent primary school nearby | Required | For long-term planning |
| East-facing preferred | Required | West-facing is a killer |

---

## Long-Term Plans

### Option A: Default Plan
- **Stay minimum 8+ years** at this place
- Then potentially upgrade
- Allows committing **$100k to renovations**
- Requirements:
  - Decent primary school in area
  - Remaining lease 70-75 years

### Option B: Investment/Rental Plan
- Buy with intention of **renting out when upgrading**
- Buy older flat at cheaper price now
- Can buy condo later **without ABSD**
- Requirements:
  - Change HFE to **owner-occupier**
  - Accept reduced grant amount

---

## Blocks/Areas Eliminated
